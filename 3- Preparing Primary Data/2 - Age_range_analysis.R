...
if(marker=="Stunting"){stunt_data <- readRDS("1- Sample Input Data/Global_stunt_SE_clean.rds")}
if(marker=="Overweight"){stunt_data <- readRDS("1- Sample Input Data/Global_over_SE_clean.rds")}
if(marker=="Underweight"){stunt_data <- readRDS("1- Sample Input Data/Global_under_SE_clean.rds")}
if(marker=="Severe_Wasting"){stunt_data <- readRDS("1- Sample Input Data/Global_sv_waste_SE_clean.rds")}
if(marker=="Wasting"){stunt_data <- readRDS("1- Sample Input Data/Global_waste_SE_clean.rds")}
...
saveRDS(stunt_data_w_pred,paste0("1- Sample Input Data/Global_",marker,"_SE_Age_clean.rds"))
